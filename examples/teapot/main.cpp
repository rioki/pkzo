...
int main(int argc, char* argv[])
{
    ...
    gltPerspective(projection, 45.0f, 800.0f/600.0f, 0.1f, 100.0f);
    ...
    window.on_draw([&] () {
        ...
        gltLoadIdentity(modelview);
        gltLookAt(modelview, 5, 5, 5, 0, 0, 0, 0, 0, 1);
        gltRotate(modelview, ax, 0, 1, 0);
        gltRotate(modelview, ay, 1, 0, 0);        
