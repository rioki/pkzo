...
namespace hello
{
    ...
    : Screen(size)
    {
        auto font = std::make_shared<pkzo::Font>("../data/fonts/DejaVuSans.ttf", 12);
        ...
        auto recangle = std::make_shared<pkzo::Rectangle>(glm::vec2{0.0f}, glm::vec2(395.0f, 117.0f), logo);
        add_node(recangle);
    }
}
